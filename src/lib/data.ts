...
export const calendarEvents = [
  {
    ...
    end: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), 9, 0),
    end: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), 10, 0),
    end: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), 11, 0),
    end: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), 13, 0),
    end: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), 14, 0),
    end: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), 14, 45),
  },
];
